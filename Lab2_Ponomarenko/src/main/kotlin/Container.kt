 ...
 */
class SamochodContainer : Container<Samochod> {
    private val samochods: MutableList<Samochod> = mutableListOf()
     ...
     */
    override fun add(element: Samochod) {
        samochods.add(element)
    }
     ...
     */
    override fun update(index: Int, element: Samochod) {
        samochods[index] = element
    }
     ...
     */
    override fun get(index: Int): Samochod {
        return samochods[index]
    }
     ...
     */
    override fun getAll(): List<Samochod> {
        return samochods
    }
}
